...
export const createList = async (req:Request, res:Response) => {
    try {
        ...
        const newList = await pool.query('INSERT INTO list (list_id,title,description,board) VALUES ($1,$2,$3,$4) RETURNING *',
        [list.id, list.title, list.description, list.boardId])
